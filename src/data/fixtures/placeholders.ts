...
const assets: Record<string, MediaAsset> = {
	...
	/* Media Pack v2 — rose photography */
	rose01: {
		id: 'rose-01',
		src: '/images/motifs/rose-01.webp',
		alt: 'Цветная тату роза на предплечье',
		width: 1200,
		height: 1800,
	},
	rose02: {
		id: 'rose-02',
		src: '/images/motifs/rose-02.webp',
		alt: 'Fine-line роза и портрет на плече',
		width: 1200,
		height: 1800,
	},
	rose03: {
		id: 'rose-03',
		src: '/images/motifs/rose-03.webp',
		alt: 'Минималистичная роза на верхней части спины',
		width: 1200,
		height: 1500,
	},
	rose04: {
		id: 'rose-04',
		src: '/images/motifs/rose-04.webp',
		alt: 'Розовая цветочная тату на спине',
		width: 1200,
		height: 1800,
	},
	rose05: {
		id: 'rose-05',
		src: '/images/motifs/rose-05.webp',
		alt: 'Небольшая роза на запястье',
		width: 1000,
		height: 667,
	},
	/* Media Pack v2 — snake photography */
	snake01: {
		id: 'snake-01',
		src: '/images/motifs/snake-01.webp',
		alt: 'Змея и цветы — blackwork на руке',
		width: 1000,
		height: 1941,
	},
	snake02: {
		id: 'snake-02',
		src: '/images/motifs/snake-02.webp',
		alt: 'Змея на предплечье — обвивающая композиция',
		width: 1200,
		height: 1800,
	},
	snake03: {
		id: 'snake-03',
		src: '/images/motifs/snake-03.webp',
		alt: 'Змея на внутренней стороне предплечья',
		width: 1200,
		height: 1800,
	},
	snake04: {
		id: 'snake-04',
		src: '/images/motifs/snake-04.webp',
		alt: 'Змея на руке — портретный кадр',
		width: 1200,
		height: 1800,
	},
	snake05: {
		id: 'snake-05',
		src: '/images/motifs/snake-05.webp',
		alt: 'Змея на руке — lifestyle кадр',
		width: 1200,
		height: 1805,
	},
	/* Media Pack v2 — minimalism / small / arm */
	minimal05: {
		id: 'minimal-05',
		src: '/images/styles/minimal-05.webp',
		alt: 'Минималистичная тату 11:11 на руке',
		width: 1000,
		height: 1500,
	},
	small01: {
		id: 'small-01',
		src: '/images/collections/small-01.webp',
		alt: 'Маленький отпечаток лапы на запястье',
		width: 1000,
		height: 1333,
	},
	small03: {
		id: 'small-03',
		src: '/images/collections/small-03.webp',
		alt: 'Маленькое сердечко на руке',
		width: 1000,
		height: 1333,
	},
	small05: {
		id: 'small-05',
		src: '/images/collections/small-05.webp',
		alt: 'Маленькая тату за ухом',
		width: 1000,
		height: 1500,
	},
	small06: {
		id: 'small-06',
		src: '/images/collections/small-06.webp',
		alt: 'Маленькая стрела на теле',
		width: 1000,
		height: 1333,
	},
	arm02: {
		id: 'arm-02',
		src: '/images/body/arm-02.webp',
		alt: 'Цветные розы и traditional на руке',
		width: 1200,
		height: 1800,
	},
	arm03: {
		id: 'arm-03',
		src: '/images/body/arm-03.webp',
		alt: 'Тату на бицепсе — объятые сердца',
		width: 1200,
		height: 1445,
	},
	/* Media Pack v2 — OTATU transparent Try-On designs (gallery/design cards) */
	tryonRose: {
		id: 'rose-transparent',
		src: '/images/tryon/rose-transparent.webp',
		alt: 'Роза — эскиз OTATU для примерки',
		width: 496,
		height: 560,
	},
	tryonSnake: {
		id: 'snake-transparent',
		src: '/images/tryon/snake-transparent.webp',
		alt: 'Змея — эскиз OTATU для примерки',
		width: 500,
		height: 560,
	},
	tryonWolf: {
		...
		alt: 'Волк — эскиз OTATU для примерки',
		width: 496,
		height: 560,
	},
}
